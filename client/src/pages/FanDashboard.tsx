  ...
  return (
    <div className="v3-dash">
      ...
      <div className="v3-dash-grid">
        {/* LEFT — primary content (Latest grid takes the visual space) */}
        <div className="v3-dash-left">
          {/* Latest content */}
          {latestPosts.length > 0 ? (
            ...
            <section className="v3-dash-section">
              <h3>Latest Content</h3>
              <div style={{ background: '#fff', borderRadius: 16, padding: '40px 20px', textAlign: 'center', border: '1px solid var(--v3-peach-soft)' }}>
                <p style={{ fontSize: '2rem', margin: '0 0 8px' }}>✨</p>
                <p style={{ margin: 0, fontSize: '0.9rem', color: 'var(--v3-ink-soft)' }}>
                  No content yet — Cristina hasn't posted. Check back soon.
                </p>
              </div>
            </section>
          )}

          {/* Recent message preview moves under Latest Content on desktop */}
          {latestCreatorMsg && (
            <Link to="/chat" className="v3-dash-msg" style={{ textDecoration: 'none', margin: 0 }}>
              <div className="avatar">
                {avatar && <img src={fullUrl(avatar)} alt="" />}
              </div>
              <div className="text">
        ...
        {/* RIGHT — sidebar (Quick Stats + Bundles) */}
          ...
          <section className="v3-dash-section">
            ...
            <div className="v3-dash-stats">
              ...
              <div className="item">
                ...
                <span className="label">PPV<br/>Messages</span>
              </div>
            </div>
          </section>
